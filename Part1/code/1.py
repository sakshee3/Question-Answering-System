...
class compute_query:
	def type1(self,runs,occurance,player_name,over,match_no):
		inning1="../dataset/"+str(match_no)+"_commentary_"+"inn1.txt"
		inning2="../dataset/"+str(match_no)+"_commentary_"+"inn2.txt"
	...
	def understand_description(self,question,description,over,match_no):
		...
		elif description.find(" out")!=-1 or description.find(" dismissed")!=-1:
			out=1
			player1_batsman=1
